...
declare class Client extends EventEmitter {
     ...
     * });
     */
    readProperty(receiver: string, objectId: {
        type: number;
        instance: number;
    }, propertyId: number, options?: object | undefined, next: Function): void;
    /**
     ...
     * });
     */
    writeProperty(receiver: string, objectId: {
        type: number;
        instance: number;
    }, propertyId: number, values: {
        type: ApplicationTag;
        value: number;
    }, options?: object | undefined, next: Function): void;
    /**
     ...
     * });
     */
    readPropertyMultiple(receiver: string, propertiesArray: {
        objectId: {
            type: number;
            instance: number;
        };
     ...
     * });
     */
    writePropertyMultiple(receiver: string, values: {
        objectId: {
            type: number;
            instance: number;
        };
     ...
     * );
     */
    confirmedCOVNotification(receiver: string, monitoredObject: {
        type: number;
        instance: number;
    }, subscribeId: number, initiatingDeviceId: number, lifetime: number, values: any[], options?: object | undefined, next: Function): void;
    /**
     ...
     * });
     */
    deviceCommunicationControl(receiver: string, timeDuration: number, enableDisable: EnableDisable, options?: object | undefined, next: Function): void;
    /**
     ...
     * });
     */
    reinitializeDevice(receiver: string, state: ReinitializedState, options?: object | undefined, next: Function): void;
    /**
     *
     * @param receiver
     * @param objectId
     ...
     * @param next
     */
    subscribeCov(receiver: any, objectId: any, subscribeId: any, cancel: any, issueConfirmedNotifications: any, lifetime: any, options: any, next: any): void;
    /**
     *
     * @param receiver
     * @param objectId
     ...
     *            ]);
     */
    unconfirmedCOVNotification(receiver: string, subscriberProcessId: number, initiatingDeviceId: number, monitoredObjectId: {
        type: number;
        instance: number;
    }, timeRemaining: number, values: {
        property: {
            id: number;
            index: number;
        };
     ...
     */
    readPropertyResponse(receiver: string, invokeId: number, objectId: object, property: object, value: any, options?: object | undefined): void;
     ...
     */
    iAmResponse(receiver: object, deviceId: number, segmentation: number, vendorId: number): void;
    /**
     *
     * @param receiver
     * @param deviceId
     ...
     * @param invokeId
     */
    simpleAckResponse(receiver: any, service: any, invokeId: any): void;
    /**
     *
     * @param receiver
     * @param service
     ...
     * @param errorCode
     */
    errorResponse(receiver: any, service: any, invokeId: any, errorClass: any, errorCode: any): void;
    /**
     *
     * @param receiver
     * @param buffer
